...
# Aplicar la función a cada celda del data frame
df <- data.frame(
  col1 = c("123.432.333", "45.67.89", "987.654", "32.2"),
  col2 = c("1.2.3", "4.5.6", "7.8.9", "9.1"),
  stringsAsFactors = FALSE
)

df <- as.data.frame(lapply(df, function(col) sapply(col, limpiar_puntos)))
